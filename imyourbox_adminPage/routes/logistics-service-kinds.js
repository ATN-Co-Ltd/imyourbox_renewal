...
const { logisticsServiceKinds } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('logisticsServiceKinds');

// This file contains the logic of every route in Forest Admin for the collection logisticsServiceKinds:
...
// Create a Logistics Service Kind
router.post('/logisticsServiceKinds', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Logistics Service Kind
router.put('/logisticsServiceKinds/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Logistics Service Kind
router.delete('/logisticsServiceKinds/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Logistics Service Kinds
router.get('/logisticsServiceKinds', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Logistics Service Kinds
router.get('/logisticsServiceKinds/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Logistics Service Kind
router.get('/logisticsServiceKinds/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Logistics Service Kinds
router.get('/logisticsServiceKinds.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Logistics Service Kinds
router.delete('/logisticsServiceKinds', permissionMiddlewareCreator.delete(), (request, response, next) => {
