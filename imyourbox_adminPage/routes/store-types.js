...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('storeTypes');

// This file contains the logic of every route in Forest Admin for the collection storeTypes:
...
// Create a Store Type
router.post('/storeTypes', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Store Type
router.put('/storeTypes/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Store Type
router.delete('/storeTypes/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Store Types
router.get('/storeTypes', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Store Types
router.get('/storeTypes/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Store Type
router.get('/storeTypes/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Store Types
router.get('/storeTypes.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Store Types
router.delete('/storeTypes', permissionMiddlewareCreator.delete(), (request, response, next) => {
