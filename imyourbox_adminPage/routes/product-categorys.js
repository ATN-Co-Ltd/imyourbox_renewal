...
const { productCategorys } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('productCategorys');

// This file contains the logic of every route in Forest Admin for the collection productCategorys:
...
router.post('/productCategorys', permissionMiddlewareCreator.create(), (request, response, next) => {
...
router.put('/productCategorys/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
router.delete('/productCategorys/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Product Categorys
router.get('/productCategorys', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Product Categorys
router.get('/productCategorys/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
router.get('/productCategorys/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Product Categorys
router.get('/productCategorys.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Product Categorys
router.delete('/productCategorys', permissionMiddlewareCreator.delete(), (request, response, next) => {
