...
const { othersOrderInfos } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('othersOrderInfos');

// This file contains the logic of every route in Forest Admin for the collection othersOrderInfos:
...
// Create a Others Order Info
router.post('/othersOrderInfos', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Others Order Info
router.put('/othersOrderInfos/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Others Order Info
router.delete('/othersOrderInfos/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Others Order Infos
router.get('/othersOrderInfos', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Others Order Infos
router.get('/othersOrderInfos/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Others Order Info
router.get('/othersOrderInfos/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Others Order Infos
router.get('/othersOrderInfos.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Others Order Infos
router.delete('/othersOrderInfos', permissionMiddlewareCreator.delete(), (request, response, next) => {
